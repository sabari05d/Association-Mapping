...
public class SaveBatchAndStudent {
	public static void main(String[] args) {
		...
		List<Batch> S1 = new ArrayList<Batch>(Arrays.asList(b1,b2,b3));
		List<Batch> S2 = new ArrayList<Batch>(Arrays.asList(b1,b2,b3));
		List<Batch> S3 = new ArrayList<Batch>(Arrays.asList(b1,b2,b3));
		List<Batch> S4 = new ArrayList<Batch>(Arrays.asList(b2));
